...
namespace ComicStoreDb.Classes
{
    ...
    public class FunctionData : IData
    {
        ...
        {
            return new FunctionRawData(this).PropValues();
        }
    }
    ...
    public class FunctionRawData : IRawData
    {
        ...
        public FunctionData Convert()
        {
            ...
            {
                Author = ComicsContext.db.Authors.Where(x => x.Name == Author).First(),
                Comic = ComicsContext.db.Comics.Where(x => x.Title == Comic).First(),
                Role = Role
            };
        }
